...
const features = [
  ...
  },
  {
    ...
    title: "Carta Digital",
    description:
      "Creá tu menú digital con fotos, descripciones y precios actualizados en tiempo real.",
  },
  {
    icon: LayoutGrid,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature) => {
            ...
            return (
              ...
              >
                <div className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-red/10">
